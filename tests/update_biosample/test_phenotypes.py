...
#         (None, None),
#     ]:
#         test_payload = BIOSAMPLE_CONTENT_XML.format(phenotypes=variant[0])
#         elements = ET.fromstring(test_payload)
#         phenotypes = get_phenotypes(elements[0])
#         assert phenotypes == variant[1][1], f"Variant '{variant[0]}' has failed"
